...
synthetic_rfi.generate_waterfall(pers_freq_gauss=5, pers_time_gauss=1, inter_freq_square=5, pers_freq_square=10, pers_time_square=4, 
                                noise=10, mean=0.5, mean_rfi=5, std_rfi=10,edge_buffer=50)
