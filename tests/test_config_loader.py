...
class TestConfigLoader:
    ...
    def test_load_valid_config(self):
        ...
        config_dict = {
            "model": {"checkpoint": "tiny", "freeze_encoders": True},
            "training": {"num_epochs": 10, "batch_size": 8, "learning_rate": 1e-4, "device": "cpu"},
            "dataset": {"stretch": "LOG10", "flag_sigma": 8, "patch_size": 256},
            "output": {"dir_path": "/tmp/test", "save_plots": False},
        }
    ...
    def test_load_partial_config_uses_defaults(self):
        ...
        config_dict = {"training": {"num_epochs": 20}}
    ...
    def test_save_config(self):
        ...
        config = TrainingConfig(model_checkpoint="small", num_epochs=15, batch_size=2, device="cpu")
